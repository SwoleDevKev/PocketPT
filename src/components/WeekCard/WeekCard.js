...
function WeekCard({week, weekNum}){
    ...
    return(
        ...
        <section className='week-card'>
            ...
            <div className='week-card__content'>
                ...
                <h3 className='week-card__subheading'><span className='week-card__span'>{`${programDays.length}x`}</span> a week</h3>
                <h3 className='week-card__subheading'><span className='week-card__span'>{totalExercises}</span> total exercises</h3>
            </div>
        </section>
